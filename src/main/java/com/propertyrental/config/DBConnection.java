...
public class DBConnection {
    private static final String URL = "jdbc:postgresql://onlineprs_database_user:pWa5iO5tZCTVCFxqwXrTuoEWvIfQl8tP@dpg-cvrnfo6r433s73avjojg-a.oregon-postgres.render.com/onlineprs_database";
